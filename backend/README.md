...
## Project Structure
    ...
    ├── mountain_adventure__35343  # Django project configurations
...
1. Clone this repo and `cd mountain_adventure__35343`
...
2. Clone this repo and `cd mountain_adventure__35343`
